...
import { CreateOrEditGroupForm } from "~/components/app/CreateOrEditGroupForm";
...
export default function Home({ loaderData }: Route.ComponentProps) {
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <NewGroup open={newGroupOpen} onClose={() => setNewGroupOpen(false)} />
    </div>
  );
}
...
function NewGroup({ open, onClose }: NewGroupProps) {
    ...
    return (
      <Dialog open={open} onOpenChange={onClose}>
        <DialogContent>
          ...
          <CreateOrEditGroupForm onClose={onClose} />
        </DialogContent>
      </Dialog>
    );
  }
